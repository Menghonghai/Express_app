...
@section('content')
    <section class="news-release max-w-screen-xl mx-auto md:py-8 my-10">
    ...
    <section class="news-carousel max-w-screen-xl mx-auto ">
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
          ...
          <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
               ...
               <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <a href="#" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200  dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <div class="flex items-center px-12 pr-16">
                        <div>
                            <h6 class="text-red-700 font-bold inline-block mr-4 mb-5 uppercase">
                                Press Releases 
                            </h6>
                            <span>28 May 2024</span>
                            <h2 class="mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">
                                Wellcome and Market Place are now on foodpanda Hong Kong
                            </h2>
                        </div>
                    </div>
                </a>
          ...
          <!-- Slider indicators -->
          <div class="text-red-900 absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
          ...
          <!-- Slider controls -->
          <button type="button" class="text-red-900 absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
              <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/90 dark:bg-gray-800/30 group-hover:bg-white/10 dark:group-hover:bg-red-800/60 group-focus:ring-4 ring-red-700 dark:group-focus:ring-red-800/70 group-focus:outline-none">
                  <svg class="w-4 h-4 text-red-700 dark:text-red-700 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
          ...
          <button type="button" class=" absolute top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
              <span class=" inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/90 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-red-700 dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                  <svg class= "w-4 h-4 text-red-700 dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                      <path class="hover:bg-red-700" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                  </svg>
    ...
    <section class="taps-news max-w-screen-xl mx-auto md:py-8 my-10 md:flex justify-between content-width pt-8 md:pt-0 mt-8 md:mt-16 ">
    ...
    <section class="card-news max-w-screen-xl mx-auto md:py-8 my-10 ">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div class="max-w-full dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5 pl-0">
                    ...
                    <a href="#">
                        <h5 class="py-4 w-5/6 mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">How foodpanda CFO Jamie O’Mahony is Navigating 2024</h5>
                    </a>
    ...
    <section class="max-w-screen-xl mx-auto md:py-8 my-10 cards-grid-section newsroom-content bg-grey-200 ">
