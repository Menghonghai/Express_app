...
@section('content')
  <section class="hero">
    ...
    <div class="title">
      <div class="" data-aos="fade-right">
        <h2 class=" md:text-5xl text-3xl">food and groceries <br>
          in a tap</h2>
        </div>
    </div>
  </section>
  <section data-aos="fade-right" class=" section__text text-left max-w-screen-xl md:mx-auto md:py-8 ">
  ...
  <section class="section__text m-section card max-w-screen-xl md:mx-auto md:px-0">
  ...
  <section class="section__text m-section card max-w-screen-xl md:mx-auto md:py-8 my-10 md:px-0">
    <div class="sm:mx-4 grid grid-cols-1 gap-6 sm:grid-cols-2 bg-white border-gray-200  dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
  ...
  <section class="section__text m-section card max-w-screen-xl md:mx-auto md:py-8 md:px-4 md:px-0">
  ...
  <section class="section__text m-section card max-w-screen-xl md:mx-auto md:py-12 my-10 md:px-4 md:px-0">
